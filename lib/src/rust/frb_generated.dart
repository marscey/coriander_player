...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1213919609;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String?> crateApiTagReaderComputeContentHash({required String path});
  ...
  Future<bool> crateApiUtilsNonWindowsImplLaunchInBrowser(
      {required String uri});

  Future<void> crateApiLoggerLogToDart({required String msg});

  Future<String?> crateApiUtilsNonWindowsImplPickSingleFolder();

  Future<String?> crateApiTagReaderReadMetadataFromBytes(
      {required List<int> headBytes,
      required List<int> tailBytes,
      required int fileSize,
      required String fileName});

  Future<bool> crateApiUtilsNonWindowsImplShowInExplorer(
      {required String path});

  Future<void> crateApiSmtcFlutterNonWindowsImplSmtcFlutterClose(
      {required SMTCFlutter that});

  SMTCFlutter crateApiSmtcFlutterNonWindowsImplSmtcFlutterNew();

  Stream<SMTCControlEvent>
      crateApiSmtcFlutterNonWindowsImplSmtcFlutterSubscribeToControlEvents(
          {required SMTCFlutter that});

  Future<void> crateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateDisplay(
      {required SMTCFlutter that,
  ...
  Future<void> crateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateState(
      {required SMTCFlutter that, required SMTCState state});

  Future<void> crateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateTimeProperties(
  ...
  Future<void> crateApiTagReaderWriteCoverToPath(
      {required String path,
  ...
  Future<void> crateApiTagReaderWriteTagsToPath(
      {required String path, required String fields});
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<String?> crateApiTagReaderComputeContentHash({required String path}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTagReaderComputeContentHashConstMeta,
      argValues: [path],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTagReaderComputeContentHashConstMeta =>
      const TaskConstMeta(
        debugName: "compute_content_hash",
        argNames: ["path"],
      );
  ...
  Future<bool> crateApiUtilsNonWindowsImplLaunchInBrowser(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiUtilsNonWindowsImplLaunchInBrowserConstMeta,
      argValues: [uri],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUtilsNonWindowsImplLaunchInBrowserConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiLoggerLogToDart({required String msg}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLoggerLogToDartConstMeta,
      argValues: [msg],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLoggerLogToDartConstMeta => const TaskConstMeta(
        debugName: "log_to_dart",
        argNames: ["msg"],
      );
  ...
  Future<String?> crateApiUtilsNonWindowsImplPickSingleFolder() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiUtilsNonWindowsImplPickSingleFolderConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUtilsNonWindowsImplPickSingleFolderConstMeta =>
      const TaskConstMeta(
  ...
  Future<String?> crateApiTagReaderReadMetadataFromBytes(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_list_prim_u_8_loose(headBytes, serializer);
        sse_encode_list_prim_u_8_loose(tailBytes, serializer);
  ...
  Future<bool> crateApiUtilsNonWindowsImplShowInExplorer(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiUtilsNonWindowsImplShowInExplorerConstMeta,
      argValues: [path],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUtilsNonWindowsImplShowInExplorerConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiSmtcFlutterNonWindowsImplSmtcFlutterClose(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_smtc_flutter(that, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterCloseConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterCloseConstMeta =>
          const TaskConstMeta(
            debugName: "smtc_flutter_close",
            argNames: ["that"],
          );
  ...
  SMTCFlutter crateApiSmtcFlutterNonWindowsImplSmtcFlutterNew() {
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_smtc_flutter,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterNewConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterNewConstMeta =>
      const TaskConstMeta(
        debugName: "smtc_flutter_new",
        argNames: [],
      );
  ...
  Stream<SMTCControlEvent>
    ...
    unawaited(handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterSubscribeToControlEventsConstMeta,
      argValues: [that, sink],
      apiImpl: this,
    )));
    return sink.stream;
  ...
  TaskConstMeta
      get kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterSubscribeToControlEventsConstMeta =>
          const TaskConstMeta(
            debugName: "smtc_flutter_subscribe_to_control_events",
            argNames: ["that", "sink"],
          );
  ...
  Future<void> crateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateDisplay(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateDisplayConstMeta,
  ...
  TaskConstMeta
      get kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateDisplayConstMeta =>
          const TaskConstMeta(
            debugName: "smtc_flutter_update_display",
  ...
  Future<void> crateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateState(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateStateConstMeta,
  ...
  TaskConstMeta
      get kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateStateConstMeta =>
          const TaskConstMeta(
            debugName: "smtc_flutter_update_state",
            argNames: ["that", "state"],
          );
  ...
  Future<void> crateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateTimeProperties(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateTimePropertiesConstMeta,
  ...
  TaskConstMeta
      get kCrateApiSmtcFlutterNonWindowsImplSmtcFlutterUpdateTimePropertiesConstMeta =>
          const TaskConstMeta(
            debugName: "smtc_flutter_update_time_properties",
  ...
  Future<void> crateApiTagReaderWriteCoverToPath(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTagReaderWriteCoverToPathConstMeta,
      argValues: [path, coverData, mimeType],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTagReaderWriteCoverToPathConstMeta =>
      const TaskConstMeta(
        debugName: "write_cover_to_path",
        argNames: ["path", "coverData", "mimeType"],
      );
  ...
  Future<void> crateApiTagReaderWriteLyricToPath(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_bool(isSynced, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      argValues: [path, lyricText, isSynced],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta get kCrateApiTagReaderWriteLyricToPathConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["path", "lyricText", "isSynced"],
      );
  ...
  Future<void> crateApiTagReaderWriteTagsToPath(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(path, serializer);
        sse_encode_String(fields, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiTagReaderWriteTagsToPathConstMeta,
      argValues: [path, fields],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTagReaderWriteTagsToPathConstMeta =>
      const TaskConstMeta(
        debugName: "write_tags_to_path",
  ...
  SMTCFlutter dco_decode_box_autoadd_smtc_flutter(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_smtc_flutter(raw);
  }
  ...
  @protected
  SMTCFlutter sse_decode_box_autoadd_smtc_flutter(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_smtc_flutter(deserializer));
  }
  ...
  void sse_encode_box_autoadd_smtc_flutter(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_smtc_flutter(self, serializer);
  }
